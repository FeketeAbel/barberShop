...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return response()->json(["success" => true, "uzenet" => $appointment->name." sikeresen rögzítésre került"], 200, ["Access-Control-Allow-Origin" => "*"], JSON_UNESCAPED_UNICODE);
    }
    ...
    public function destroy(Request $request) {
        ...
        try {
            ...
            return response()->json(["success" => false, "uzenet" => "Nem létező időpont!"], 400, options: JSON_UNESCAPED_UNICODE);
        }
